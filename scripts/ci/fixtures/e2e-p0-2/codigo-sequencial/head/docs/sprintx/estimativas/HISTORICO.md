...
entradas:
  ...
  - trabalho_id: codigo-sequencial
    task_id: T-01.01
    tipo_task: config
    area: modulo proximo-codigo e reexport em src/index.js
    sinais: []
    estimado_min: null
    estimado_max: null
    estimado_media: null
  ...
  - trabalho_id: codigo-sequencial
    task_id: T-02.01
    tipo_task: dominio
    area: propagacao do erro de proximoNumero
    sinais: []
    estimado_min: null
    estimado_max: null
    estimado_media: null
  ...
  - trabalho_id: codigo-sequencial
    task_id: T-02.02
    tipo_task: dominio
    area: codigo SEQ- a partir de proximoNumero
    sinais: []
    estimado_min: null
    estimado_max: null
    estimado_media: null
  ...
  - trabalho_id: codigo-sequencial
    task_id: T-02.03
    tipo_task: dominio
    area: padding de 6 digitos sem truncar
    sinais: []
    estimado_min: null
    estimado_max: null
    estimado_media: null
...
| codigo-sequencial | T-01.01 | config | modulo proximo-codigo e reexport em src/index.js | — | null | null | 0,1 h | 0,01 h | null |
| codigo-sequencial | T-02.01 | dominio | propagacao do erro de proximoNumero | — | null | null | 0,2 h | 0,01 h | null |
| codigo-sequencial | T-02.02 | dominio | codigo SEQ- a partir de proximoNumero | — | null | null | 0,1 h | 0,01 h | null |
| codigo-sequencial | T-02.03 | dominio | padding de 6 digitos sem truncar | — | null | null | 0,1 h | 0,01 h | null |

Os trabalhos `contador-sequencial` e `codigo-sequencial` rodaram sem a F3.5: estimado e desvio em `null`, real preenchido.
